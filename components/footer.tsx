  ...
  const socialLinks = [
    {
      ...
      url: "https://www.linkedin.com/in/anshul-soni-9036b73a6",
      name: "LinkedIn",
      gradient: "from-blue-500 to-blue-600",
    },
    {
      icon: <Github className="h-5 w-5" />,
      url: "https://github.com/Sonijianshul256",
      name: "GitHub",
        ...
        <div className="flex flex-col items-center justify-between gap-8 sm:flex-row">
          ...
          >
            <p className="text-sm text-slate-400">
              © {currentYear} <span className="text-white font-semibold">Anshul Soni</span>. All rights reserved.
            </p>
