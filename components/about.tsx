        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          >
            <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 hover:border-slate-700 transition-colors flex-1">
              ...
              >
                <p>
                  I'm Anshul Soni, a drone developer and embedded systems
                  engineer obsessed with building hardware that operates
                  reliably at the edge — where software meets the physical
                  world.
                </p>
                <p>
                  My work spans autonomous flight systems, low-level firmware,
                  and custom PCB design. From tuning PID loops on flight
                  controllers to writing bare-metal drivers for STM32
                  microcontrollers, I work across the full hardware stack.
                </p>
                <p>
                  I care deeply about the details that hardware demands —
                  real-time constraints, power budgets, and signal integrity. If
                  it flies, spins, or talks over a bus, I want to understand
                  exactly why.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-sky-500/10 to-slate-900/50 backdrop-blur-sm border border-sky-500/30 rounded-2xl p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  >
                    Firmware that crashes in the field isn't an option. I build
                    with reliability first — clean state machines, tight
                    interrupt logic, and hardware that does exactly what it's
                    told, every time.
                  </p>
                </div>
              </div>
